...
The site builder ships one package per app, so a module several apps need has
to exist in each: this is ``vec_playground/compat.py`` again.
``test_labels_compat`` compares the two functions and fails if they drift apart.
"""
